...
def send_message(request):
    ...
    try:
        ...
        history_messages = list(conversation.messages.values('role', 'content')[:20])
        ...
        # if any(phrase in user_message.lower() for phrase in ['schedule', 'consultation', 'book a call', 'meeting']):
        #     response_data['ask_details'] = True
...
def refresh_context(request):
    ...
    if request.method == 'POST':
        ...
        return JsonResponse({'success': True, 'message': 'Chatbot context refreshed successfully'})
